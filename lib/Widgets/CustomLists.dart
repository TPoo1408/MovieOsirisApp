...
class _CustomListMovieState extends State<CustomListMovie>
  ...
  // khi danh sách bị cuộn và một số phần tử không còn hiển thị trên màn hình,
  // nhưng vẫn được duy trì ở trạng thái keep alive -> khi cuộn lại không cần phải khởi tạo lại.
  @override
